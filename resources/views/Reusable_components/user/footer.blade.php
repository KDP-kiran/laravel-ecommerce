  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        <h6 class="text-uppercase mb-4 font-weight-bold">BLACKQR</h6>
        <p>Blackqr Sustainable Affordable Fashionable Fabrics. Helping to the famers creating extra revenue. Empowerment of women by giving employment as per their work.</p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>
          <i class="fas fa-home mr-3"></i>  SKU, Ahmedabad  -382470</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> kdpatel1110@gmail.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> kiran : +91 8347586906</p>
        <p>
          <i class="fas fa-phone mr-3"></i>jaimin : +91 7778976464</p>
      </div>
      <!-- Grid column -->
    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <p class="text-center text-md-left">© 2023 Copyright:
          <a href="#">
            <strong>blackqr.com</strong>
          </a>
          <br>
          <span> Developed by <a href="https://www.blackqr.com" target="_blank" style=" font-family: 'Balsamiq Sans', cursive;"><u>Kiran</u></a> </span>
        </p>
